...
Class(function Device() {
    ...
    this.browser.safari = !this.browser.chrome && this.detect("safari");x
...
Class(function AssetLoader(i) {
    ...
    function a(r) {
        if (r) {
            ...
            o = o[o.length - 1];
            var p = o.split(".");
            var q = p[p.length - 1].split("?")[0];
            switch (q) {
                case "html":
                    XHR.get(r, function(t) {
                        Hydra.HTML[p[0]] = t;
                        m(r)
                    }, "text");
                    break;
...
Class(function Mobile() {
    ...
    this.scrollTop = 0;
    if (Device.mobile) {
        for (var r in Device.browser) {
            Device.browser[r] = false
        }
        setInterval(n, 250);
        ...
        this.version = (function() {
            try {
                if (o.os == "iOS") {
                    var u = Device.agent.split("os ")[1].split("_");
                    var b = u[0];
                    var v = u[1].split(" ")[0];
                    return Number(b + "." + v)
                }
                if (o.os == "Android") {
                    var t = Device.agent.split("android ")[1].split(";")[0];
                    if (t.length > 3) {
                        t = t.slice(0, -2)
                    }
                    return Number(t)
        ...
        function q() {
            ...
            setTimeout(function() {
                ...
                o.events.fire(HydraEvents.RESIZE)
            }, 100)
        }

        function a() {
            o.orientation = Math.abs(window.orientation) == 90 ? "landscape" : "portrait";
            setTimeout(function() {
                Stage.width = window.innerWidth;
                Stage.height = window.innerHeight;
            ...
            if (o.tablet && o.browser == "Chrome" && i) {
                i = window.innerHeight
            }
            if (o.phone && i) {
                i = Stage.height;
                if (o.orientation == "portrait" && o.browser == "Safari") {
                    s = false;
                    document.body.scrollTop = 0
                }
            }
        ...
        function d(v) {
            ...
            var u = v.target;
            var t = u.nodeName == "INPUT" || u.nodeName == "TEXTAREA" || u.nodeName == "SELECT";
            if (o.allowScroll) {
                return
            }
            if (i) {
        ...
        function p(u) {
            var v = Utils.touchEvent(u);
            if (o.allowScroll) {
                return
            }
            if (m.target && Mobile.os == "iOS") {
                var t = m.target;
                var b = t.__scrollHeight || Number((t.style.height || "0px").slice(0, -2));
                t.__scrollheight = b;
                if (v.y < m.y) {
                    if (Math.round(t.scrollTop) == Math.round(b / 2)) {
                        u.preventDefault()
                    }
                } else {
                    if (t.scrollTop == 0) {
    ...
    function n() {
        ...
        if (e) {
            if (b - e > o.sleepTime) {
                o.events.fire(HydraEvents.BACKGROUND)
            }
        }
        e = b
    }
    ...
    function g(b) {
        ...
        if (o.scrollTop > 20) {
            s = true;
            i = Stage.height;
            o.events.fire(HydraEvents.FULLSCREEN, {
                fullscreen: true
            })
        }
        h()
    ...
    this.fullscreen = function() {
        if (o.os == "Android") {
            ...
            if (o.os == "iOS" && o.version >= 7) {
                if (true || o.browser == "Chrome" || o.browser == "Safari") {
                    l();
                    return true
                }
            }
    ...
    this.overflowScroll = function(t, b, v) {
        if (!Device.mobile) {
            return false
        }
        var u = {
...
Spark.
Class(function Attractor(b, c, d) {
    Inherit(this, Component);
    var h = this;
...
D3.
Class(function PerspectiveProjection() {
    var c = this;
...
Class(function CSSAnimation(a) {
    ...
    function f() {
        var t = CSS._read();
        var o = "/*" + m + "*/";
        var D = "@-" + Device.vendor + "-keyframes " + m + " {\n";
        var u = o + D;
        if (t.strpos(m)) {
            var w = t.split(o);
            t = t.replace(o + w[1] + o, "")
        ...
        for (var s = 0; s < d.length; s++) {
            ...
            for (B in C) {
                var r = C[B];
                if (typeof r !== "string" && B != "opacity" && B != "zIndex") {
                    r += "px"
                }
                u += CSS._toCSS(B) + ": " + r + ";"
            }
...
Class(function Warp(i) {
    ...
    function h(v, k, B, p, C, q, n, x, o, z, u, l, w, m, D, r) {
        var t = b(v, k, C, q, o, z, w, m);
        var A = b(B, p, n, x, u, l, D, r);
        return f(A, g(t))
    }
    ...
    function a(v, u, o) {
        ...
        var z = v[3].x;
        var p = v[3].y;
        var x = h(0, 0, m, s, u, 0, l, r, 0, o, k, q, u, o, z, p);
        for (var n = 0; n < 9; n++) {
            x[n] = x[n] / x[8]
        }
...
Class(function CanvasShader(w, v, x) {
    ...
    function j() {
        ...
        var B = typeof w == "string" ? w : Utils.getBackground(w);
        g = new Image();
        g.src = B;
        g.onload = function() {
            g.width = w.width;
    ...
    function q() {
        ...
        x = x || 1;
        for (var C = 0; C < x; C++) {
            var B = u.initClass(Thread);
            B.initCode(s, v);
            B.initFunction(a, true);
            B.initFunction(z, true);
            B.initFunction(i);
            B.initFunction(t);
            k.push(B)
        }
    ...
    function b(C) {
        var D = p.createImageData(g.width, g.height);
        var E = p.getImageData(0, 0, g.width, g.height);
    ...
    function c(D, E) {
        var B = u.initClass(Canvas);
        var C = Utils.getBackground(D);
        var F = new Image();
        F.src = C;
        F.onload = function() {
            B.size(F.width, F.height, u.retina);
            B.context.drawImage(F, 0, 0, F.width, F.height);
            if (D.css) {
                D.css({
                    background: ""
                }).addChild(B)
            ...
            var G = d();
            if (u.preprocess) {
                u.preprocess(B.context, F, B)
            }
            E = E || {};
            E.imageData = B.context.getImageData(0, 0, F.width, F.height);
            G.send(s, E, function(H) {
                B.context.putImageData(H, 0, 0);
                if (u.postprocess) {
                    u.postprocess(B.context, F, B)
                }
                D.removeChild(B, true);
                B = B.destroy()
            })
        }
    }
    ...
    function i(B) {
        self.buffer = B.emptyData;
        self.image = B.imageData;
    ...
    function a(C) {
        var B = new Uint8ClampedArray(self.image.data);
        return B
    }
...
window.Config.ASSETS = ["assets/images/about/awards/adc.png", "assets/images/about/awards/addy.png", "assets/images/about/awards/awwwards.png", "assets/images/about/awards/cannes.png", "assets/images/about/awards/dnad.png", "assets/images/about/awards/emmy.png", "assets/images/about/awards/fwa.png", "assets/images/about/awards/oneshow.png", "assets/images/about/awards/webby.png", "assets/images/about/bg.jpg", "assets/images/about/logo.png", "assets/images/common/272737.png", "assets/images/common/f1f1f1.png", "assets/images/common/f4f4f4.png", "assets/images/common/loader.png", "assets/images/common/rotate.png", "assets/images/contact/bg.jpg", "assets/images/favicon.png", "assets/images/home/logo-invert.png", "assets/images/home/logo-stacked.png", "assets/images/home/logo-wide.png", "assets/images/home/particle-gl.png", "assets/images/home/particle0-gl.jpg", "assets/images/home/particle1-gl.jpg", "assets/images/home/particle2-gl.jpg", "assets/images/home/spark-gl.jpg", "assets/images/loader/letter.png", "assets/images/loader/logo.png", "assets/images/share/apple-touch-icon.png", "assets/images/share/share.jpg", "assets/images/sidebar/fb.png", "assets/images/sidebar/line.png", "assets/images/sidebar/logo.png", "assets/images/sidebar/nav/about-off.png", "assets/images/sidebar/nav/about-on.png", "assets/images/sidebar/nav/contact-off.png", "assets/images/sidebar/nav/contact-on.png", "assets/images/sidebar/nav/lab-off.png", "assets/images/sidebar/nav/lab-on.png", "assets/images/sidebar/nav/work-off.png", "assets/images/sidebar/nav/work-on.png", "assets/images/sidebar/tw.png", "assets/images/work/awards/adc.png", "assets/images/work/awards/addy.png", "assets/images/work/awards/cannes.png", "assets/images/work/awards/dnad.png", "assets/images/work/awards/fwa.png", "assets/images/work/awards/oneshow.png", "assets/images/work/awards/webby.png", "assets/images/work/black.jpg", "assets/images/work/gradient.png", "assets/images/work/halftone.png", "assets/images/work/logos/bolthouse.png", "assets/images/work/logos/chevy.png", "assets/images/work/logos/coke.png", "assets/images/work/logos/fox.png", "assets/images/work/logos/google.png", "assets/images/work/logos/ua.png", "assets/images/work/overlay.png", "assets/images/work/white.png", "assets/shaders/Additive.fs", "assets/shaders/BaseVertex.vs", "assets/shaders/Godray.fs", "assets/shaders/Scan.fs"];
...
Class(function ATDevice() {
    var a = this;
    this.WIDTH = window.innerWidth;
    this.HEIGHT = window.innerHeight;
    this.PERFORMANCE = 2;
    this.IE9 = Device.browser.ie && Device.browser.version == 9;
    this.CHROME36 = Device.browser.chrome && Device.browser.version == 36;
    this.IOS8 = Mobile.os == "iOS" && Mobile.version > 7;
    ...
    this.getAsset = function(c, b) {
        return "http://" + c.bucket + ".activetheorylab.net/" + c.media + "/" + c.media + "." + b
    };
    this.getDetailAsset = function(c, b) {
        return "http://" + c.bucket + ".activetheorylab.net/" + c.media + "/images/" + b + ".jpg"
    };
        ...
        for (var c = 0; c < e.length; c++) {
            for (var b = 0; b < Config.ASSETS.length; b++) {
                if (Config.ASSETS[b].strpos(e[c])) {
                    d.push(a.parseAsset(Config.ASSETS[b]))
                }
            }
        }
        return d
    ...
    setInterval(function() {
        if (Device.browser.chrome && Device.system.retina) {
            if (Stage.width > 1440) {
                a.PARALLAX_ITEMS = false;
                a.PERFORMANCE = 0
            } else {
                a.PARALLAX_ITEMS = true;
                a.PERFORMANCE = 2
            }
        }
    }, 500)
...
Class(function MathUtil() {
    ...
    function c() {
        var h = b(new Vector2(ATDevice.width, 0), new Vector2(0, 0));
        var g = Math.ceil(Math.abs(h.y * 1.8));
        return {
            total: g > e ? g : e,
            triangle: g
        }
    ...
    function b(h, g) {
        var i = new Vector2(-(g.y - h.y), g.x - h.x).multiply(Math.sin(Utils.toRadians(d)));
        var j = new Vector2().copyFrom(h).add(i);
        return j
    }
    this.getSliceHeight = function() {
        var g = c().total;
        if (Stage.height > ATDevice.width) {
            g *= 2
        }
        if (g > 360) {
            g = 360
        }
        if (g < 260 && !Mobile.phone) {
            g = 260
        }
        if (Mobile.phone) {
            g = 190
...
Class(function VideoUtil() {
    ...
    function f(o) {
        if (Data.STATE.page == "work") {
            var l = Data.STATE.deep;
            var p = Data.WORK.getDeep(l);
            if (p) {
                e.push(p.media);
                e.push(Data.WORK.getNext(p, -1).media);
                e.push(Data.WORK.getNext(p, 1).media)
            }
        }
        for (var m = 0; m < o.length; m++) {
            if (e.indexOf(o[m].media) == -1) {
                e.push(o[m].media)
            }
        }
        for (var m = 0; m < o.length; m++) {
            ...
            j[n.media].events.add(HydraEvents.READY, d);
            j[n.media].events.add(HydraEvents.ERROR, c);
            j[n.media].volume(0);
            j[n.media]._data = n
        }
        a(j[e[0]]);
    ...
    function a(l) {
        ...
        var m = l._data;
        l.src = "http://" + m.video + "/" + m.media + "." + Device.media.video;
        l.canPlayTo(10)
    }
    ...
    this.getVideo = function(l) {
        return j[l]
    };
    this.getSrc = function(l) {
        return "http://" + l.bucket + ".activetheorylab.net/" + l.media + "/" + l.media
    };
    this.getReel = function() {
        return b
    };
    this.buffered = function(l) {
        return j[l].buffered
    }
}, "Static");
...
Class(function StateModel() {
    ...
    function a() {
        ...
        if (d.page != "about" && d.page != "home" && d.page != "work" && d.page != "lab") {
            d.page = "home"
        }
    }

    function b() {
        d.dispatcher.events.add(HydraEvents.UPDATE, c)
    }

    function c(f) {
        a();
        d.events.fire(ATEvents.STATE_CHANGE)
    }
    this.setState = function(e) {
        GATracker.trackPage(e);
        this._setState(e);
        a();
        d.events.fire(ATEvents.PAGE_CHANGE)
    }
});

Class(function WorkModel(c) {
    Inherit(this, Model);
    var d = this;
    var b = c.slice(0);
    (function() {
    ...
    this.getImages = function() {
        var e = [];
        for (var f = 0; f < c.length; f++) {
            e.push(ATDevice.getAsset(c[f], "jpg"))
        }
        return e
    };
...
Class(function AboutModel(c) {
    ...
    function a() {
        var h = c.titles.split("\n");
        var g = 0;
        c.titles = [];
        for (var f = 0; f < h.length / 3; f++) {
            var j = {};
            j.top = h[g];
            j.bottom = h[g + 1];
            c.titles.push(j);
    ...
    function d() {
        var f = new Object();
        var l = c.awards.split("\n");
        for (var h = 0; h < l.length; h++) {
            var j = l[h].split("(")[0].trim().toLowerCase();
            f[j] = Number(l[h].split("(")[1].split(")")[0])
        }
        var g = Data.WORK.getOGData();
        for (var h in g) {
            var k = g[h];
            if (k.awards) {
                var l = k.awards.indexOf("\n") > -1 ? k.awards.split("\n") : [k.awards];
                for (var h = 0; h < l.length; h++) {
                    var j = l[h].split("(")[0].trim().toLowerCase();
...
Class(function LabModel(b) {
    ...
    this.getImages = function() {
        var d = [];
        for (var e = 0; e < b.length; e++) {
            d.push(ATDevice.getAsset(b[e], "jpg"))
        }
        return d
    };
    this.getNext = function(f, e) {
        var d = b.indexOf(f);
        d += e;
        if (d < 0) {
            d = b.length - 1
...
Class(function Data() {
    ...
    function a() {
        d.WORK = new WorkModel(c.work);
        d.LAB = new LabModel(c.lab);
        d.ABOUT = new AboutModel(c.about);
        d.STATE = new StateModel()
    }
}, "Static");
...
Class(function Loader() {
    ...
    function e() {
        o = h.container;
        o.size("100%").bg(Config.COLORS.grey)
    }

    function b() {
        g = h.initClass(LoaderView);
        h.view = g;
        h.delayedCall(m, Device.mobile ? 750 : 500)
    }
    ...
    function m() {
        ...
        ATDevice.bundleAssets(["common", "shaders", "sidebar", "contact", (Data.STATE.page == "lab" ? "work" : Data.STATE.page) + "/"], l);
        l.push(Config.PROXY + "assets/js/lib/three.min.js");
        c();
        d = h.initClass(AssetLoader, l);
        d.add(10);
        d.events.add(HydraEvents.PROGRESS, a);
        d.events.add(HydraEvents.COMPLETE, i);
        n = h.initClass(PerformanceTest);
        n.events.add(HydraEvents.COMPLETE, f)
    }
    ...
    function j() {
        var r = [];
        for (var q = 0; q < Config.ASSETS.length; q++) {
            r.push(ATDevice.parseAsset(Config.ASSETS[q]))
        }
        c(Data.WORK.getImages(), r);
        c(Data.LAB.getImages(), r);
    ...
    function i() {
        h.delayedCall(j, 500);
        h.delayedCall(function() {
            h.events.fire(HydraEvents.COMPLETE);
            if (!Device.mobile) {
                h.delayedCall(g.move, 250)
            } else {
                h.delayedCall(g.fade, 250)
            }
        }, 100)
    }
...
Class(function PerformanceTest() {
    ...
    function o() {
        c = true;
        ATDevice.PERFORMANCE = 0;
        ATDevice.PERF_TIME = 0;
        j.events.fire(HydraEvents.COMPLETE)
    }

    function i(t) {
        ATDevice.PERF_TIME = 2;
        if (Device.mobile) {
            var s = Device.detect(["fban", "facebook", "fbios", "twitter"]);
            if (Mobile.os == "iOS") {
                if (Mobile.version >= 7) {
                    if (Mobile.browser == "Safari" && !s) {
                        ATDevice.PERFORMANCE = t > 20 ? 0 : 1;
                        ATDevice.PERF_TIME = t > 20 ? 0 : 1
                    } else {
                        ATDevice.PERFORMANCE = 0;
                        ATDevice.PERF_TIME = t > 150 ? 0 : 1
                    }
                } else {
                    ATDevice.PERF_TIME = 0;
                    ATDevice.PERFORMANCE = 0
            ...
            if (t <= q) {
                ATDevice.PERFORMANCE = 2
            } else {
                if (t < r) {
                    ATDevice.PERFORMANCE = 1
                } else {
                    ATDevice.PERFORMANCE = 0
                }
